...
#define T2_PRE_1_128    0xFF
#define T2_PRE_1_64     0xEF
#define T2_PRE_1_32     0xDF
#define T2_PRE_1_16     0xCF
#define T2_PRE_1_8      0xBF
#define T2_PRE_1_4      0xAF
#define T2_PRE_1_2      0x9F
#define T2_PRE_1_1      0x8F

#define T2_POST_1_1     0xF0
...
/*****
 * This function sets the prescale value for Timer2
 * 
 * Timer2 must be disabled (off) before setting the prescale value
*****/
